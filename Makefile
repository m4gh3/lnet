...
example_training: examples/example_training.c build/mmatrix.o build/arrays.o build/processing.o
	gcc $(CFLAGS) `projcfg -li` -lm -lpng -lpngdraw examples/example_training.c build/mmatrix.o build/arrays.o build/processing.o -o $(OUTDIR)/example_training

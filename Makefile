...
example_training: examples/example_training.c build/mmatrix.o build/arrays.o
	gcc $(CFLAGS) `projcfg -li` -lm -lpng -lpngdraw examples/example_training.c build/mmatrix.o build/arrays.o -o $(OUTDIR)/example_training
